...
#define RAM_TRANSLATION_CACHE_SIZE (1024 * 1024 * 2)
...
#define CODE_CACHE_ALIGN		4096
#define CODE_CACHE_ALIGN_MASK	(CODE_CACHE_ALIGN - 1)

extern u8 rom_translation_cache_static[ROM_TRANSLATION_CACHE_SIZE + 4096];
extern u8 ram_translation_cache_static[RAM_TRANSLATION_CACHE_SIZE + 4096];
extern u8 bios_translation_cache_static[BIOS_TRANSLATION_CACHE_SIZE + 4096];
